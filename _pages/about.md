...
- **王笑辰**, 李世娟, 黄文胜, 赵红梅, 张润彤<sup>\*</sup>. 融合先验知识与多源异构数据的临床误诊风险预测与特征识别研究. *数据分析与知识发现*, 待刊印. (**Xiaochen Wang**, Shijuan Li, Wensheng Huang, Hongmei Zhao, Runtong Zhang<sup>\*</sup>. Integrating prior knowledge with multi-source heterogeneous data for clinical misdiagnosis risk prediction and feature identification. *Data Analysis and Knowledge Discovery*, forthcoming.)
